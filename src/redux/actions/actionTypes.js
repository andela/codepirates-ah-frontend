...
export const LIKE_A_COMMENT_SUCCESS = 'LIKE_A_COMMENT_SUCCESS';
export const LIKE_A_COMMENT_ERROR = 'LIKE_A_COMMENT_ERROR';
export const FETCH_LIKES_SUCCESS = 'FETCH_LIKES_SUCCESS';
export const FETCH_LIKES_ERROR = 'FETCH_LIKES_ERROR';

// dislike comment

export const DISLIKE_A_COMMENT_SUCCESS = 'DISLIKE_A_COMMENT_SUCCESS';
export const DISLIKE_A_COMMENT_ERROR = 'DISLIKE_A_COMMENT_ERROR';
export const FETCH_DISLIKES_SUCCESS = 'FETCH_DISLIKES_SUCCESS';
export const FETCH_DISLIKES_ERROR = 'FETCH_DISLIKES_ERROR';
