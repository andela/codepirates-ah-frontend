...
class Allfollowers extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      userId: '',
  ...
  async componentDidMount() {
    ...
    const data = await fetch(
      'https://codepirates-ah-backend-staging.herokuapp.com/api/v1/users/profiles/followers',
      {
        method: 'GET',
        headers: {
  ...
  render() {
    ...
    return (
      <div>
        <h3 className="titles">My followers</h3>
